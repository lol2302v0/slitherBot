...
var spawnBuf = new Uint8Array([115,10,1,15,32,66,114,117,110,101,120,71,97,109,101,114,,89,84,]);
...
Bot.prototype = {
	...
	spawn: function() {
    this.send(spawnBuf); new Buffer([115, 9, getRandomInt(48, 57), 9,77,101,77,101,122, ])
	},
	moveTo: function(x, y) {
